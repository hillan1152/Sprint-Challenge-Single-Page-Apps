...
> Answer: Client-side routing helps reload the page smoother between pages. It tricks the code by changing small portions of the URL, while continuing to mimic the appearance of the web page. 
